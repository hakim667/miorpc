...
const Page = () => {
  ...
  const onClickValidate = async (index) => {
    ...
    await validateDecision(decisions[index])
      .then((res) => {
        if (res.status) {
          alert(res.message);
        } else {
  ...
  const onClickReject = async (index) => {
    ...
    await rejectDecision(decisions[index])
      .then((res) => {
        if (res.status) {
          alert(res.message);
        } else {
    ...
    <div className=" bg-background h-screen flex flex-col">
      ...
      <div className=" h-[90%] flex flex-col items-center pt-4">
        <div className=" w-[95%] h-[70%] flex flex-col gap-4 ">
          <h1 className=" text-2xl font-bold">Consulter décisions :</h1>
                    ...
                    <div className=" w-[23%] p-1 flex flex-row gap-4">
                      <div className=" flex-1">
                        <Button
                          ...
                          loading={
                            loading[0] === index && loading[1] === "validate"
                          }
                        />
                      </div>
                      <div className=" flex-1">
                        <Button
                          ...
                          loading={
                            loading[0] === index && loading[1] === "reject"
                          }
                        />
                      </div>
                    </div>
